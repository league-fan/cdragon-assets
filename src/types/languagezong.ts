...
export const languageZoneToBCP47: Record<LanguageZone, string> = {
  ...
  [LanguageZone.ChineseMainland]: "zh-CN",
...
export const languageZoneToName: Partial<Record<LanguageZone, string>> = {
  ...
  [LanguageZone.ChineseMainland]: "中文（简体）",
...
export const bcp47ToLanguageZone: Record<string, LanguageZone> = Object
  .fromEntries(
