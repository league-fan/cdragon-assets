...
export enum EsportsEvent {
    AllStar = "All-Star",
    CampeonatoBrasileiroDeLeagueOfLegends = "Campeonato Brasileiro de League of Legends",
    CopaLatinoaméricaSur = "Copa Latinoamérica Sur",
    EuropeLeagueOfLegendsChampionshipSeries = "Europe League of Legends Championship Series",
    ...
    NorthAmericaLeagueOfLegendsChampionshipSeries = "North America League of Legends Championship Series",
    OceanicProLeague = "Oceanic Pro League",
    OnGameNetLeagueOfLegendsInvitational = "OnGameNet League of Legends Invitational",
